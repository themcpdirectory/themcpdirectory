...
for (const [colorScheme, expected] of [
  ["light", { background: "#fcfcfc", accent: "#087523" }],
  ["dark", { background: "#151515", accent: "#82f68e" }],
] as const) {
  test(`uses the supplied brand canvas and accent in ${colorScheme} mode`, async ({ page }) => {
