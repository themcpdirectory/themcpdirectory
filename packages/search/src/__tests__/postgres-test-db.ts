...
async function chooseAdminConnectionString(): Promise<string> {
  ...
  throw new Error("Unable to establish a local PostgreSQL admin connection for search integration tests.");
}
...
export async function createTempDatabase(prefix = "task6_search"): Promise<TempDatabase> {
